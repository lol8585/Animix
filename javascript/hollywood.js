let hollywoodSongs = [
    { songName: "Alan Walker K-391", filePath: "songs/hollywood/1.mp3", coverPath: "images/hollywood covers/1.jpg" },
    { songName: "INDUSTRY BABY", filePath: "songs/hollywood/2.mp3", coverPath: "images/hollywood covers/2.jpg" },
    { songName: "Astronaut in the Ocean", filePath: "songs/hollywood/3.mp3", coverPath: "images/hollywood covers/3.jpg" },
    { songName: "Wavin' Flag ", filePath: "songs/hollywood/4.mp3", coverPath: "images/hollywood covers/4.jpg" },
    { songName: "death bed", filePath: "songs/hollywood/5.mp3", coverPath: "images/hollywood covers/5.jpg" },
    { songName: "The Final Countdown", filePath: "songs/hollywood/6.mp3", coverPath: "images/hollywood covers/6.jpg" },
    { songName: "Gangsta's Paradise", filePath: "songs/hollywood/7.mp3", coverPath: "images/hollywood covers/7.jpg" },
    { songName: "They Don’t Care About Us ", filePath: "songs/hollywood/8.mp3", coverPath: "images/hollywood covers/8.jpg" },
    { songName: "We Don't Talk Anymore", filePath: "songs/hollywood/9.mp3", coverPath: "images/hollywood covers/9.jpg" },
]
...
function songFunction(song, i) {
  song.getElementsByClassName("songCardName")[0].innerHTML = hollywoodSongs[i].songName;
  song.getElementsByTagName('img')[0].src = hollywoodSongs[i].coverPath;
...
function displayBottomBar() {
  ...
  function songCardButtonFunction(element) {
    element.addEventListener('click', function (event) {
      ...
      if (audioElement.paused && audioElement.currentTime <= 0) {
        ...
        audioElement.src = `songs/hollywood/${event.target.id}.mp3`;
        audioElement.play();
  
        // Change Bottom Image and Text
        songNumber = parseInt(event.target.id);
        music_playing.innerHTML = hollywoodSongs[songNumber - 1].songName;
        playingImage.src = hollywoodSongs[songNumber - 1].coverPath;
      }
  ...
  next.addEventListener('click', function () {
    ...
    // Play Next Song
    audioElement.src = `songs/hollywood/${songNumber}.mp3`;
